    ...
    >
      <div className="bg-neutral-900 p-6 rounded-lg max-w-2xl max-h-[80vh] overflow-y-auto">
        ...
        <div className="space-y-4">
          ...
          <section>
            <h3 className="text-lg font-semibold">2. Data Privacy and Protection</h3>
            <p className="text-white">We collect and process facial data for the sole purpose of attendance tracking. Your facial data will be:</p>
          ...
          <section>
            ...
            <p className="text-gray-700">We strive to maintain high accuracy in our facial recognition system, but cannot guarantee 100% accuracy at all times. We are not liable for:</p>
            <ul className="list-disc ml-5 text-gray-700">
          ...
          <section>
            ...
            <p className="text-gray-700">We reserve the right to modify these terms at any time. Users will be notified of significant changes, and continued use of the system constitutes acceptance of revised terms.</p>
          </section>
          
          <section>
            <h3 className="text-lg font-semibold">6. Account Security</h3>
            <p className="text-gray-700">You are responsible for maintaining the confidentiality of your account credentials. Any activities that occur under your account are your responsibility. Notify us immediately of any unauthorized use of your account.</p>
          </section>
          
          <section>
            <h3 className="text-lg font-semibold">7. Intellectual Property</h3>
            <p className="text-gray-700">All content, features, and functionality of this system, including but not limited to text, graphics, logos, icons, and images, are the exclusive property of our company and are protected by copyright, trademark, and other intellectual property laws.</p>
          </section>
        </div>
